...
The current Panacea Mainnet version is [v2.3.0](https://github.com/medibloc/panacea-core/releases/tag/v2.3.0).
...
- Version: Panacea Core [v2.3.0](https://github.com/medibloc/panacea-core/releases/tag/v2.3.0)
- Chain ID: `panacea-3`
